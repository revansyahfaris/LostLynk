...
// Mapping status DB → angka step untuk stepper tracker
const statusToStep = {
  pending: 1,
  verified: 2,
  at_counter: 3,
...
const CariBarang = () => {
  ...
  // Fetch data dari Supabase saat komponen pertama kali dimuat
  useEffect(() => {
    fetchItems();
  }, []);
  ...
  const fetchItems = async () => {
    ...
    setError('');
    try {
      // Fetch found_item dan lost_item secara paralel
      ...
      // Normalisasi found_item ke format tampilan
      ...
      // Normalisasi lost_item ke format tampilan
      ...
      console.error('Gagal fetch items:', err.message);
  ...
  // Buka modal detail + tampilkan toast notification
    ...
    <div className="container" style={{ paddingTop: '2rem', position: 'relative' }}>
        ...
        {isLoading ? (
          [1, 2, 3, 4, 5, 6].map((n) => (
            ...
            >
              <div
                className="shimmer"
                style={{ width: '60px', height: '20px', background: '#f1f5f9', borderRadius: '4px' }}
              />
              <div
                className="shimmer"
                style={{ width: '80%', height: '24px', background: '#e2e8f0', borderRadius: '4px' }}
              />
              <div
                className="shimmer"
                style={{ width: '50%', height: '16px', background: '#f1f5f9', borderRadius: '4px' }}
              />
            </div>
          ))
          ...
          >
            {items.length === 0
              ...
              : `❌ Tidak ada barang cocok dengan pencarian "${search}"`}
          </div>
        ) : (
          filteredData.map((item) => (
            <div
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow = '0 8px 20px rgba(14, 165, 233, 0.08)';
              }}
              onMouseLeave={(e) => {
      ...
      {selectedBarang && (
        <div
          ...
          onClick={(e) => {
            if (e.target === e.currentTarget) setSelectedBarang(null);
          }}
        >
          <div
            style={{
          ...
          >
            ...
            <span
              className={`badge badge-${selectedBarang.status}`}
            ...
            <h4 style={{ marginBottom: '1rem', fontSize: '0.9rem', fontWeight: '600' }}>
              📌 Alur Verifikasi Logistik Barang:
            </h4>
            <div
              style={{
                display: 'flex',
            ...
            >
              ...
              <div
                style={{
                  ...
                  top: '15px',
                  left: '20px',
                  width: `${((selectedBarang.step - 1) / 3) * 91}%`,
                  height: '3px',
                  ...
                  >
                    <div
                      style={{
                        ...
                        height: '32px',
                        borderRadius: '50%',
                        background: isDone ? 'var(--accent)' : '#ffffff',
                        border: isDone ? '2px solid var(--accent)' : '2px solid #cbd5e1',
